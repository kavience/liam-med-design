...
import { get, map, set, indexOf, filter, isEmpty, cloneDeep, values } from 'lodash';
import InputWithLabel from '../input-with-label';
import MultipleInputWithLabel, { Option as MultipleInputWithLabelOption } from '../multiple-input-with-label';
    ...
    <Checkbox.Group value={get(data, 'checkedValues')} onChange={handleBoxGroupChange} style={{ width: '100%' }}>
      <Row>
        {map(options, (option, index) => {
          ...
          return (
            <Col offset={offset} span={span} key={index}>
