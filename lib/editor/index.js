...
var Editor = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Editor, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_braftEditor["default"], _extends({}, this.props, {
        style: _objectSpread({
          border: bordered ? '1px solid #d9d9d9' : ''
        }, style),
    ...
    value: function getDerivedStateFromProps(prevProps, state) {
      if (state.value || !prevProps.value) return {};

      var value = _braftEditor["default"].createEditorState(prevProps.value);
