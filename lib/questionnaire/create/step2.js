...
var _radio = _interopRequireDefault(require("../assets/radio.png"));

var _checkbox = _interopRequireDefault(require("../assets/checkbox.png"));

var _select = _interopRequireDefault(require("../assets/select.png"));

var _vacancy = _interopRequireDefault(require("../assets/vacancy.png"));

var _stars = _interopRequireDefault(require("../assets/stars.png"));

var _description = _interopRequireDefault(require("../assets/description.png"));
...
var chooseArray = [{
  title: '单选题',
  value: 'radio',
  iconImg: _radio["default"]
}, {
  title: '多选题',
  value: 'multiple',
  iconImg: _checkbox["default"]
}, {
  title: '下拉题',
  value: 'dropdown',
  iconImg: _select["default"]
}, {
  title: '填空题',
  value: 'completion',
  iconImg: _vacancy["default"]
}];
exports.chooseArray = chooseArray;
var starArray = [{
  title: '打分题',
  value: 'star',
  iconImg: _stars["default"]
}];
exports.starArray = starArray;
var descArray = [{
  title: '段落说明',
  value: 'descption',
  iconImg: _description["default"]
}];
  ...
  function Step2(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderBtns", function () {
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          key: index,
          className: "question-step-two__panel-question-card-item"
        }, /*#__PURE__*/_react["default"].createElement("span", {
          className: "question-step-two__panel-question-card-item__title"
        }, (0, _lodash.get)(btn, 'title')), /*#__PURE__*/_react["default"].createElement("div", {
          className: "question-step-two__panel-question-card-item__btns"
          ...
          return /*#__PURE__*/_react["default"].createElement("div", {
            ...
            src: (0, _lodash.get)(item, 'iconImg'),
            alt: ""
          }), /*#__PURE__*/_react["default"].createElement("div", null, (0, _lodash.get)(item, 'title')));
        })));
      })));
    });
    ...
    _this.state = {
      ...
      title: (0, _lodash.get)(_data, 'title') || '',
      description: (0, _lodash.get)(_data, 'description') || '',
  ...
  _createClass(Step2, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, /*#__PURE__*/_react["default"].createElement(_antd.Row, {
        ...
        onChange: function onChange(e) {
          _this2.setState({
            title: (0, _lodash.get)(e, 'target.value')
          });
        }
      })), /*#__PURE__*/_react["default"].createElement(_antd.Form.Item, {
        label: "\u95EE\u5377\u63CF\u8FF0",
        ...
        onChange: function onChange(e) {
          _this2.setState({
            description: (0, _lodash.get)(e, 'target.value')
          });
        }
      })), /*#__PURE__*/_react["default"].createElement("div", {
        ...
        onClick: function onClick() {
          ...
          onPreview && onPreview(_objectSpread(_objectSpread({}, data), {}, {
            questions: questions,
      ...
      }, "\u4E0B\u4E00\u6B65")))), /*#__PURE__*/_react["default"].createElement(_antd.Col, {
        span: 6,
        offset: 1
